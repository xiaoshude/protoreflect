...
[![Go Report Card](https://goreportcard.com/badge/github.com/xiaoshude/protoreflect)](https://goreportcard.com/report/github.com/xiaoshude/protoreflect)
...
[![GoDoc](https://godoc.org/github.com/xiaoshude/protoreflect?status.svg)](https://godoc.org/github.com/xiaoshude/protoreflect)

----
## Descriptors: The Language Model of Protocol Buffers

```go
import "github.com/xiaoshude/protoreflect/desc"
```
...
*[Read more ≫](https://godoc.org/github.com/xiaoshude/protoreflect/desc)*

```go
import "github.com/xiaoshude/protoreflect/desc/protoparse"
```
...
*[Read more ≫](https://godoc.org/github.com/xiaoshude/protoreflect/desc/protoparse)*

```go
import "github.com/xiaoshude/protoreflect/desc/protoprint"
```
...
*[Read more ≫](https://godoc.org/github.com/xiaoshude/protoreflect/desc/protoprint)*

```go
import "github.com/xiaoshude/protoreflect/desc/builder"
```
...
*[Read more ≫](https://godoc.org/github.com/xiaoshude/protoreflect/desc/builder)*

----
## Dynamic Messages and Stubs

```go
import "github.com/xiaoshude/protoreflect/dynamic"
```
...
*[Read more ≫](https://godoc.org/github.com/xiaoshude/protoreflect/dynamic)*

```go
import "github.com/xiaoshude/protoreflect/dynamic/grpcdynamic"
```
...
*[Read more ≫](https://godoc.org/github.com/xiaoshude/protoreflect/dynamic/grpcdynamic)*

----
## gRPC Server Reflection

```go
import "github.com/xiaoshude/protoreflect/grpcreflect"
```
...
*[Read more ≫](https://godoc.org/github.com/xiaoshude/protoreflect/grpcreflect)*
